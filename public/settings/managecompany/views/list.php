...
<h2 class="az-content-title">Manage Company</h2>
                        ...
                        <div class="panel-title">
                            ...
                            <div class="panel-right">
                                <button type="button" class="btn btn-info"
                                    onclick="push({'view':'add','viewpage':''})"><i class="la la-plus"></i> Add</button>
                            </div>
                        </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-append" id="button-addon4">
                                                        ...
                                                        <button class="btn btn-info"
                                                            onclick="document.getElementById('fdsearch').value='';document.myform.submit;">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <img class="imgphoto" src="<?php echo 'uploads/brands/'.$val['COMP_BRAND'];?>" alt="photo"
                                                onError="this.src='media/img/building.png'" avatar></td>
                                        <td><?php echo $val['COMP_NAME'];?></td>
                                        <td><?php echo $val['COMP_EMAIL'];?></td>
                                        <td><?php echo $val['COMP_PHONE'];?></td>
                                        <td><?php echo (($val['COMP_STATUS']==='2'))? '<i class="las la-square-full actives"></i>':'<i class="las la-square-full inactive"></i>';?>
                                        </td>
                                        <td width="80px">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <button class="dropdown-item" type="button"
                                                        onclick="push({'view':'manage','keys':'<?php echo $val['COMP_CODE'];?>','viewpage':'edit'})"><i
                                                            class="la la-briefcase"></i> Manage</button>
                                                    <button class="dropdown-item" type="button"
                                                        onclick="push({'view':'add','keys':'<?php echo $val['COMP_CODE'];?>','viewpage':'edit'})"><i
                                                            class="la la-pen-nib"></i> Edit</button>
                                                    <button class="dropdown-item"
                                                        <?php echo(($val['COMP_CODE']== $userid))?"disabled":"";?>
                                                        type="button"
                                                        onclick="deletData('delete','<?php echo $val['COMP_CODE'];?>')"><i
