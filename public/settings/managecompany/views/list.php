                                ...
                                <div class="col-sm-12">
                                    <div class="page form">
                                        <div class="row" style="padding-top:20px;padding-bottom:20px;">
                                            ...
                                            <div class="col">
                                                <span
                                                    style="float:right;"><?php echo $paging->page_count($paging);?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <img src="<?php echo 'uploads/brands/'.$val['COMP_BRAND'];?>" alt="photo"
                                                onError="this.src='theme/assets/img/placeholder.jpg'" avatar></td>
