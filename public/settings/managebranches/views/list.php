                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <img src="<?php  echo WEB_UPLOADS.$list->getcompanybrand($companycode);?>" alt="photo" onError="this.src='theme/assets/img/placeholder.jpg'" avatar></td>
                                        <td><?php echo $val['BRA_NAME'];?></td>
                                        <td><?php echo $val['BRA_EMAIL'];?></td>
                                        <td><?php echo $val['BRA_PHONE'];?></td>
                                        <td><?php echo (($val['BRA_STATUS']==='2'))? '<i class="las la-square-full actives"></i>':'<i class="las la-square-full inactive"></i>';?></td>
                                        <td width="80px">
                                            <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <button class="dropdown-item" type="button" onclick="push({'view':'add','keys':'<?php echo $val['BRA_CODE'];?>','viewpage':'edit'})"><i class="la la-pen-nib"></i> Edit</button>
                                                        <button class="dropdown-item" <?php echo(($val['BRA_CODE']== $userid))?"disabled":"";?> type="button" onclick="deletData('delete','<?php echo $val['BRA_CODE'];?>')"><i class="la la-trash"></i> Delete</button>
                                                    </div>
                                                </div>
                                        </td>
                                    </tr>
