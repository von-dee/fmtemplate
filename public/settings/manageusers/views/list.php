                ...
                <div class="col-md-12">
                    ...
                    <div class="panel-title">
                        ...
                        <div class="panel-right">
                            <button type="button" class="btn btn-primary" onclick="push({'view':'add','viewpage':''})"><i class="la la-plus"></i> Add</button>
                        </div>
                    </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="200px">
                                            <button type="button" class="btn btn-primary" onclick="push({'view':'edit','keys':'<?php echo $val['USR_CODE'];?>','viewpage':'edit'})"><i class="la la-pen-nib"></i> Edit</button>
