                ...
                <div class="col-md-12">
                    ...
                    <div class="panel-title">
                        ...
                        <div class="panel-right">
                            <button type="button" class="btn btn-info" onclick="push({'view':'add','viewpage':''})"><i class="la la-plus"></i> Add</button>
                        </div>
                    </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="200px">
                                            <button type="button" class="btn btn-info" onclick="push({'view':'edit','keys':'<?php echo $val['USR_CODE'];?>','viewpage':'edit'})"><i class="la la-pen-nib"></i> Edit</button>
                                            <button type="button" <?php echo(($val['USR_CODE']== $userid))?"disabled":"";?> class="btn btn-danger" onclick="deletData('delete','<?php echo $val['USR_CODE'];?>')"><i class="la la-trash"></i> Delete</button>
                                        </td>
                                    </tr>
                                    <?php }}else{?>
                                    <tr>
