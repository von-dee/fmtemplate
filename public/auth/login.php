    ...
    <div class="wrapper">
        <div class="login-form centered">
            <div class="row login-content">
                <div class="col-sm-12">
                    <div class="brand"><img src="<?php echo APP_LOGO;?>" alt="logo" width="200px"></div>
                </div>
                ...
                <div class="col-lg-5 col-sm-12 login-block">
                    ...
                    <form action="index.php?action=index&pg=1" method="post" enctype="application/x-www-form-urlencoded"
                        ...
                        <div class="btn-block">
                            ...
                            <!-- <a href="index.php?action=forgetpassword" class="btn btn-secondary login-btn pt-2">Register</a><br> -->
                        </div>
                        
                        <div class="more-info">
                            <a href="index.php?action=forgetpassword" class="forgot-link">Forgot password?</a>
