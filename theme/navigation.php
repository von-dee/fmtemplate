      ...
      <div class="dropdown az-header-notification">
        ...
        <div class="dropdown-menu">
          ...
          <div class="az-notification-list">
            <div class="media new">
              <div class="az-img-user"><img src="media/img/faces/face2.jpg" alt=""></div>
            ...
            <div class="media new">
              <div class="az-img-user online"><img src="media/img/faces/face3.jpg" alt=""></div>
              <div class="media-body">
            ...
            <div class="media">
              <div class="az-img-user"><img src="media/img/faces/face4.jpg" alt=""></div>
              <div class="media-body">
            ...
            <div class="media">
              <div class="az-img-user"><img src="media/img/faces/face5.jpg" alt=""></div>
              <div class="media-body">
